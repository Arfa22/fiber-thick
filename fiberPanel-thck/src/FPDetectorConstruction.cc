...
// Fiber (inside cladding) - Yellow

G4VisAttributes* fiberVisAtt = new G4VisAttributes(G4Colour::Yellow()); // Yellow color for fiber
fiberVisAtt->SetVisibility(true);
fiberVisAtt->SetForceSolid(true);
FiberLV->SetVisAttributes(fiberVisAtt);


// Cladding (surrounding fiber) - Magenta color with wireframe mode
G4VisAttributes* claddingVisAtt = new G4VisAttributes(G4Colour::Magenta()); // Magenta color for cladding
claddingVisAtt->SetVisibility(true);
claddingVisAtt->SetForceWireframe(true); // Set to wireframe mode to see the boundary
CladdingLV->SetVisAttributes(claddingVisAtt);
